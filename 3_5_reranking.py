...
def doc_qid_correctness(doc_id, docs_correctness_dict):
    ...
    triples = docs_correctness_dict[doc_id]["triples"]
...
if __name__ == "__main__":
    ...
    # TREC 2020
    topicality = f"./misinfo-runs/adhoc/2020/run.misinfo-2020-description.bm25_en.txt"
    correctness = f"./data/correctness_scores/trec2020_first_stage_retrieved_docs_passages_RDF_triples_full_graph_abstract_triple-level_correctness_scores_dense-10-match.json"
    output = f"./misinfo-runs/adhoc/2020/"
    print("Reranking TREC 2020...")
